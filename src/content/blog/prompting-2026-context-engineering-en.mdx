...
<CompareGrid
  title="The shift"
  leftLabel="Old prompting vibe"
  rightLabel="2026 vibe"
  rows={[
    { left: 'Find the perfect sentence.', right: 'Assemble the right context.' },
    { left: 'Stuff more detail into one prompt.', right: 'Remove what the model should not see.' },
    { left: 'Read the answer and hope.', right: 'Check output with schemas, tests, and evals.' },
  ]}
/>
