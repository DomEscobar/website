...
description: "Eine praktische Notiz für moderne AI-Entwicklung: LLM-native Entwickler brauchen Datenlebenszyklus, Model Ops, Evals, Incident Playbooks, Human-AI UX und Coding-Agent-Harnesses."
language: "de"
...
1. **Schreib die Failure Story vor dem Feature.** Was ist der wahrscheinlichste dumme Fehler? Falscher Kontext, falsches Tool, falsches Modellverhalten, zu hohe Kosten, fehlende Freigabe?
2. **Gib jedem Agenten klare Grenzen.** Wenn er Daten schreibt, Nachrichten sendet oder Geld bewegt, brauchst du Permissions, Logs, Idempotency und Undo.
3. **Mach aus jedem Fehler ein Eval.** Wenn ein Fehler passiert, wird daraus ein Testfall. Sonst reparierst du nur Bauchgefühl.
