...
<CompareGrid
  title="Der Shift"
  leftLabel="Alter Prompting-Vibe"
  rightLabel="2026-Vibe"
  rows={[
    { left: 'Den perfekten Satz finden.', right: 'Den richtigen Kontext zusammenstellen.' },
    { left: 'Mehr Details in einen Prompt stopfen.', right: 'Unwichtiges bewusst weglassen.' },
    { left: 'Antwort lesen und hoffen.', right: 'Output mit Schema, Tests und Evals prüfen.' },
  ]}
/>
