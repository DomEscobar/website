...
export const buildprints: Buildprint[] = [
  ...
  },
  {
    ...
    files: ["BUILDPRINT.md", "CONTRACTS.md", "PLAN.md", "README.md", "SPEC.md", "TEST_MATRIX.md", "VALIDATION_TEMPLATE.md", "evals/check-map.mjs", "evals/golden-projects/admin-dashboard/expected-signals.json"],
