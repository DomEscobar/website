...
export const buildprints: Buildprint[] = [
  {
    ...
    files: ["BUILDPRINT.md", "SPEC.md", "CONTRACTS.md", "RBAC_MATRIX.md", "API_ROUTES.md", "UI_FLOWS.md", "TEST_MATRIX.md", "proof/src/index.ts", "proof/test/rbac.test.ts", "conformance/src/adapter-contract.ts", "conformance/test/auth-rbac.conformance.test.ts"],
