...
export const buildprints: Buildprint[] = [
  {
    ...
    includes: ["Auth forensics", "Tenant boundary map", "Permission engine", "Invite lifecycle", "Audit log", "Offline TypeScript proof"],
    risks: ["Frontend-only authorization", "Cross-tenant data leaks", "Self-escalation or last-owner loss"],
    files: ["BUILDPRINT.md", "SPEC.md", "CONTRACTS.md", "RBAC_MATRIX.md", "API_ROUTES.md", "UI_FLOWS.md", "TEST_MATRIX.md", "proof/src/index.ts", "proof/test/rbac.test.ts"],
    checks: ["Phase 00 forensics must complete first", "Permission engine denies by default", "Every team-scoped route has direct API auth tests", "Invites and role changes emit redacted audit events", "Offline proof harness is included and testable"],
