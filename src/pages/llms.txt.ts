...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    '- Agent Buildprints: executable phase-flow contracts with prompts, setup gates, runtime evidence schemas, review loops, proof gates, and replay validation for coding agents.',
